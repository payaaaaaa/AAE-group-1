...
def main():
    ...
    for i in range(-10, 30): # draw the free border1
        ox.append(20.0)
        oy.append(i)
    for i in range(5,60): # draw the free border2
        ox.append(40)
        oy.append(i)
    for i in range(20,50): # draw the free border3
        ox.append(i)
        oy.append(40)
    for i in range(45,60): # draw the free border4
        ox.append(i)
        oy.append(35)
    for i in range(40,55): # draw the free border5
        ox.append(i)
        oy.append(10)
    for i in range(35,45): # draw the free border6
        ox.append(i)
        oy.append(5)
